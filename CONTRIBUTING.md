...
7) Below is a code snippet for reference as to what has to ADDED in the file. Inside the `<b> </b>` tag you have to put your name, in the `<href >` tag, you have to place your github profile URL. And lastly you have to place your github profile photo url inside the `src` tag.
    ...
    ```
    <td align="center">
        <a href="https://wasscodeur.me/">
            <img src="https://avatars.githubusercontent.com/u/55312000?v=4" width="100px;" alt="Wachiou BOURAIMA"/>
            <br />
            <sub><b>Wachiou BOURAIMA</b></sub>
        </a>
    </td>
     <td align="center">
        <a href="https://github.com/WassCodeur">
            <img src="https://avatars.githubusercontent.com/u/100234404?v=4" width="100px;" alt="Neeraj Madake"/>
            <br />
            <sub><b>WassCodeur
        </a>
    </td>
